...
![コアダッシュボードとバージョン管理](docs/screenshots/zh-CN/1.png)
...
![OAuth アカウント認証](docs/screenshots/zh-CN/2.png)
...
![API プロバイダー統合](docs/screenshots/zh-CN/3.png)
...
![エージェントクライアント設定](docs/screenshots/zh-CN/4.png)
