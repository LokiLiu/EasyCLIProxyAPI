...
v0.2.10 是一次性桥接版本：它会同时发布完整 Windows ZIP 和兼容旧客户端的 `update` ZIP，使 v0.2.6–v0.2.9 可以通过应用内更新升级到 v0.2.10。v0.2.11 起只发布完整 ZIP；已升级到 v0.2.10 的客户端可以识别完整包并跨过多个中间版本直接升级。
